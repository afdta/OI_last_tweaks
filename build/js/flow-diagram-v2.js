...
export default function flow_diagram(container){
    ...
    var svg_right = right_panel.append("svg").attr("width","100%").attr("height",svg_height);
    ...
    function update_(cbsa){
        ...
        var max_share;
        try{
            var flow = occ_flows[cbsa][sub_ba ? "Sub" : "BA"];
            var shares = occ_shares[cbsa][sub_ba ? "Sub" : "BA"].slice(0);
